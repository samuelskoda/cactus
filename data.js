...
window.CACTI = [
  { id: "espostoa-melanostele", file: "photos/IMG_9481.jpeg", name: "Espostoa melanostele", tag: "Espostoa melanostele", genus: ["Espostoa"], region: ["Andes"], origin: "Peru (Andes)",
  ...
  { id: "coryphantha-cornifera", file: "photos/IMG_9482.jpeg", name: "Coryphantha cornifera", tag: "Coryphantha cornifera", genus: ["Coryphantha"], region: ["Mexico & SW USA"], origin: "Central Mexico",
  ...
  { id: "astrophytum-asterias", file: "photos/IMG_9483.jpeg", name: "Astrophytum asterias", tag: "Astrophytum asterias", genus: ["Astrophytum"], region: ["Mexico & SW USA"], origin: "N Mexico & S Texas",
  ...
  { id: "echinopsis-ancistrophora-1", file: "photos/IMG_9484.jpeg", name: "Echinopsis ancistrophora", tag: "Lobivia ancistrophora", genus: ["Echinopsis"], region: ["Southern South America"], origin: "Argentina & Bolivia",
  ...
  { id: "mammillaria-spinosissima", file: "photos/IMG_9485.jpeg", name: "Mammillaria spinosissima", tag: "Mammillaria spinosissima", genus: ["Mammillaria"], region: ["Mexico & SW USA"], origin: "Central Mexico",
  ...
  { id: "stenocactus-multicostatus", file: "photos/IMG_9486.jpeg", name: "Stenocactus multicostatus", tag: "Stenocactus multicostatus", genus: ["Stenocactus"], region: ["Mexico & SW USA"], origin: "N & Central Mexico",
  ...
  { id: "echinopsis-aurea", file: "photos/IMG_9487.jpeg", name: "Echinopsis aurea", tag: "Echinopsis aurea", genus: ["Echinopsis"], region: ["Southern South America"], origin: "Argentina",
  ...
  { id: "astrophytum-myriostigma-1", file: "photos/IMG_9488.jpeg", name: "Astrophytum myriostigma", tag: "Astrophytum myriostigma", genus: ["Astrophytum"], region: ["Mexico & SW USA"], origin: "N Mexico",
  ...
  { id: "astrophytum-myriostigma-2", file: "photos/IMG_9489.jpeg", name: "Astrophytum myriostigma", tag: "Astrophytum myriostigma", genus: ["Astrophytum"], region: ["Mexico & SW USA"], origin: "N Mexico",
  ...
  { id: "mammillaria-karwinskiana", file: "photos/IMG_9490.jpeg", name: "Mammillaria karwinskiana", tag: "Mammillaria karwinskiana", genus: ["Mammillaria"], region: ["Mexico & SW USA"], origin: "S Mexico (Oaxaca)",
    blurb: "A green pincushion with sparse, long pale spines and stout tubercles. The ID isn't certain — it may be the same species as the single-headed compressa, #mammillaria-compressa-1. To separate M. karwinskiana from M. compressa, watch how it clumps (karwinskiana splits its head in two; compressa offsets into a dense mound) and the flower colour (karwinskiana cream with a red midstripe; compressa purple-pink); both bleed milky latex when cut.", uncertain: true },

  { id: "ferocactus-emoryi", file: "photos/IMG_9491.jpeg", name: "Ferocactus emoryi", tag: "Ferocactus emoryi", genus: ["Ferocactus"], region: ["Mexico & SW USA"], origin: "Mexico / SW USA",
  ...
  { id: "stenocactus-crispatus", file: "photos/IMG_9492.jpeg", name: "Stenocactus crispatus", tag: "Stenocactus crispatus", genus: ["Stenocactus"], region: ["Mexico & SW USA"], origin: "Central Mexico",
  ...
  { id: "parodia-leninghausii", file: "photos/IMG_9493.jpeg", name: "Parodia leninghausii", tag: "Parodia leninghausii", genus: ["Parodia"], region: ["Southern South America"], origin: "S Brazil",
  ...
  { id: "matucana-aureiflora", file: "photos/IMG_9494.jpeg", name: "Matucana aureiflora", tag: "Matucana aureiflora", genus: ["Matucana"], region: ["Andes"], origin: "N Peru (Andes)",
  ...
  { id: "mammillaria-compressa-1", file: "photos/IMG_9495.jpeg", name: "Mammillaria compressa", tag: "Mammillaria compressa", genus: ["Mammillaria"], region: ["Mexico & SW USA"], origin: "Central Mexico",
    blurb: "A single green head with dense white radial spines. Being solitary, it's hard to call for certain — it could be a young Mammillaria compressa, or the same species as #mammillaria-karwinskiana. Useful clues when it matures: flower colour (compressa purple-pink vs karwinskiana cream with a red stripe), the wool and bristles in the axils, and the spine count per areole.", uncertain: true },

  { id: "kroenleinia-grusonii-1", file: "photos/IMG_9496.jpeg", name: "Kroenleinia grusonii", tag: "Kroenleinia grusonii", genus: ["Kroenleinia"], region: ["Mexico & SW USA"], origin: "Central Mexico",
  ...
  { id: "stenocactus-coptonogonus", file: "photos/IMG_9497.jpeg", name: "Stenocactus coptonogonus", tag: "Stenocactus coptonogonus", genus: ["Stenocactus"], region: ["Mexico & SW USA"], origin: "Central Mexico",
  ...
  { id: "parodia-erubescens", file: "photos/IMG_9498.jpeg", name: "Parodia × erubescens", tag: "Parodia × erubescens", genus: ["Parodia"], region: ["Southern South America"], origin: "Uruguay (hybrid)",
  ...
  { id: "coryphantha-elephantidens", file: "photos/IMG_9499.jpeg", name: "Coryphantha elephantidens", tag: "Coryphantha elephantidens", genus: ["Coryphantha"], region: ["Mexico & SW USA"], origin: "Central Mexico",
  ...
  { id: "mammillaria-compressa-2", file: "photos/IMG_9500.jpeg", name: "Mammillaria compressa", tag: "— (tag not legible; identified by owner)", genus: ["Mammillaria"], region: ["Mexico & SW USA"], origin: "Central Mexico",
  ...
  { id: "gymnocalycium-saglionis-1", file: "photos/IMG_9501.jpeg", name: "Gymnocalycium saglionis", tag: "Gymnocalycium saglionis", genus: ["Gymnocalycium"], region: ["Southern South America"], origin: "N Argentina",
  ...
  { id: "echinopsis-ancistrophora-2", file: "photos/IMG_9502.jpeg", name: "Echinopsis ancistrophora", tag: "Lobivia ancistrophora", genus: ["Echinopsis"], region: ["Southern South America"], origin: "Argentina & Bolivia",
  ...
  { id: "mammillaria-matudae", file: "photos/IMG_9503.jpeg", name: "Mammillaria matudae", tag: "Mammillaria matudae", genus: ["Mammillaria"], region: ["Mexico & SW USA"], origin: "Central Mexico (Guerrero)",
  ...
  { id: "echinopsis-oxygona-1", file: "photos/IMG_9504.jpeg", name: "Echinopsis oxygona", tag: "Echinopsis oxygona", genus: ["Echinopsis"], region: ["Southern South America"], origin: "S Brazil / Uruguay / Argentina",
  ...
  { id: "gymnocalycium-saglionis-2", file: "photos/IMG_9505.jpeg", name: "Gymnocalycium saglionis", tag: "Gymnocalycium saglionis", genus: ["Gymnocalycium"], region: ["Southern South America"], origin: "N Argentina",
  ...
  { id: "mammillaria-hahniana", file: "photos/IMG_9506.jpeg", name: "Mammillaria hahniana", tag: "Mammillaria hahniana", genus: ["Mammillaria"], region: ["Mexico & SW USA"], origin: "Central Mexico",
  ...
  { id: "mammillaria-bombycina", file: "photos/IMG_9507.jpeg", name: "Mammillaria bombycina", tag: "Mammillaria bombycina", genus: ["Mammillaria"], region: ["Mexico & SW USA"], origin: "Central Mexico",
  ...
  { id: "echinopsis-oxygona-2", file: "photos/IMG_9508.jpeg", name: "Echinopsis oxygona", tag: "Echinopsis oxygona", genus: ["Echinopsis"], region: ["Southern South America"], origin: "S Brazil / Uruguay / Argentina",
  ...
  { id: "parodia-magnifica-1", file: "photos/IMG_9509.jpeg", name: "Parodia magnifica", tag: "Parodia magnifica", genus: ["Parodia"], region: ["Southern South America"], origin: "S Brazil",
  ...
  { id: "parodia-magnifica-2", file: "photos/IMG_9513.jpeg", name: "Parodia magnifica", tag: "Parodia magnifica", genus: ["Parodia"], region: ["Southern South America"], origin: "S Brazil",
  ...
  { id: "mammillaria-vetula", file: "photos/IMG_9510.jpeg", name: "Mammillaria vetula", tag: "— (tag not legible; identified by owner)", genus: ["Mammillaria"], region: ["Mexico & SW USA"], origin: "Central Mexico",
  ...
  { id: "mammillaria-elongata", file: "photos/IMG_9511.jpeg", name: "Mammillaria elongata", tag: "Mammillaria elongata", genus: ["Mammillaria"], region: ["Mexico & SW USA"], origin: "Central Mexico",
  ...
  { id: "mixed-dish-bowl", file: "photos/IMG_9514.jpeg", name: "Mixed seedling dish", tag: "— (dish planting)",
  ...
  { id: "disocactus-ackermannii", file: "photos/IMG_9515.jpeg", name: "Disocactus ackermannii", tag: "Disocactus ackermannii", genus: ["Disocactus"], region: ["Mexico & SW USA"], origin: "SE Mexico (forests)",
  ...
  { id: "cumulopuntia-boliviana", file: "photos/IMG_9516.jpeg", name: "Cumulopuntia boliviana", tag: "Cumulopuntia boliviana", genus: ["Cumulopuntia"], region: ["Andes"], origin: "Bolivia / Peru / Argentina (Andes)",
  ...
  { id: "echinopsis-oxygona-bowl", file: "photos/IMG_9517.jpeg", name: "Echinopsis offshoots", tag: "— (no tag; identified by owner)",
  ...
  { id: "kroenleinia-grusonii-2", file: "photos/IMG_9518.jpeg", name: "Kroenleinia grusonii", tag: "— (no tag; identified by owner)", genus: ["Kroenleinia"], region: ["Mexico & SW USA"], origin: "Central Mexico",
