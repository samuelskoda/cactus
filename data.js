...
window.CACTI = [
  ...
  { id: "coryphantha-cornifera", file: "photos/coryphantha-cornifera/IMG_9482.jpeg", name: "Coryphantha cornifera", tag: "Coryphantha cornifera", genus: ["Coryphantha"], region: ["Mexico & SW USA"], origin: "Central Mexico",
  ...
  { id: "stenocactus-multicostatus", file: "photos/stenocactus-multicostatus/IMG_9486.jpeg", name: "Stenocactus multicostatus", tag: "Stenocactus multicostatus", genus: ["Stenocactus"], region: ["Mexico & SW USA"], origin: "N & Central Mexico",
  ...
  { id: "echinopsis-aurea", file: "photos/echinopsis-aurea/IMG_9487.jpeg", name: "Echinopsis aurea", tag: "Echinopsis aurea", genus: ["Echinopsis"], region: ["Southern South America"], origin: "Argentina",
  ...
  { id: "astrophytum-myriostigma-1", file: "photos/astrophytum-myriostigma-1/IMG_9488.jpeg", name: "Astrophytum myriostigma", tag: "Astrophytum myriostigma", genus: ["Astrophytum"], region: ["Mexico & SW USA"], origin: "N Mexico",
  ...
  { id: "astrophytum-myriostigma-2", file: "photos/astrophytum-myriostigma-2/IMG_9489.jpeg", name: "Astrophytum myriostigma", tag: "Astrophytum myriostigma", genus: ["Astrophytum"], region: ["Mexico & SW USA"], origin: "N Mexico",
  ...
  { id: "mammillaria-karwinskiana", file: "photos/mammillaria-karwinskiana/IMG_9490.jpeg", name: "Mammillaria karwinskiana", tag: "Mammillaria karwinskiana", genus: ["Mammillaria"], region: ["Mexico & SW USA"], origin: "S Mexico (Oaxaca)",
  ...
  { id: "ferocactus-emoryi", file: "photos/ferocactus-emoryi/IMG_9491.jpeg", name: "Ferocactus emoryi", tag: "Ferocactus emoryi", genus: ["Ferocactus"], region: ["Mexico & SW USA"], origin: "Mexico / SW USA",
  ...
  { id: "stenocactus-crispatus", file: "photos/stenocactus-crispatus/IMG_9492.jpeg", name: "Stenocactus crispatus", tag: "Stenocactus crispatus", genus: ["Stenocactus"], region: ["Mexico & SW USA"], origin: "Central Mexico",
  ...
  { id: "parodia-leninghausii", file: "photos/parodia-leninghausii/IMG_9493.jpeg", name: "Parodia leninghausii", tag: "Parodia leninghausii", genus: ["Parodia"], region: ["Southern South America"], origin: "S Brazil",
  ...
  { id: "matucana-aureiflora", file: "photos/matucana-aureiflora/IMG_9494.jpeg", name: "Matucana aureiflora", tag: "Matucana aureiflora", genus: ["Matucana"], region: ["Andes"], origin: "N Peru (Andes)",
  ...
  { id: "mammillaria-compressa-1", file: "photos/mammillaria-compressa-1/IMG_9495.jpeg", name: "Mammillaria compressa", tag: "Mammillaria compressa", genus: ["Mammillaria"], region: ["Mexico & SW USA"], origin: "Central Mexico",
  ...
  { id: "kroenleinia-grusonii-1", file: "photos/kroenleinia-grusonii-1/IMG_9496.jpeg", name: "Kroenleinia grusonii", tag: "Kroenleinia grusonii", genus: ["Kroenleinia"], region: ["Mexico & SW USA"], origin: "Central Mexico",
  ...
  { id: "stenocactus-coptonogonus", file: "photos/stenocactus-coptonogonus/IMG_9497.jpeg", name: "Stenocactus coptonogonus", tag: "Stenocactus coptonogonus", genus: ["Stenocactus"], region: ["Mexico & SW USA"], origin: "Central Mexico",
  ...
  { id: "parodia-erubescens", file: "photos/parodia-erubescens/IMG_9498.jpeg", name: "Parodia × erubescens", tag: "Parodia × erubescens", genus: ["Parodia"], region: ["Southern South America"], origin: "Uruguay (hybrid)",
  ...
  { id: "coryphantha-elephantidens", file: "photos/coryphantha-elephantidens/IMG_9499.jpeg", name: "Coryphantha elephantidens", tag: "Coryphantha elephantidens", genus: ["Coryphantha"], region: ["Mexico & SW USA"], origin: "Central Mexico",
  ...
  { id: "mammillaria-compressa-2", file: "photos/mammillaria-compressa-2/IMG_9500.jpeg", name: "Mammillaria compressa", tag: "— (tag not legible; identified by owner)", genus: ["Mammillaria"], region: ["Mexico & SW USA"], origin: "Central Mexico",
  ...
  { id: "echinopsis-oxygona-1", file: "photos/echinopsis-oxygona-1/IMG_9504.jpeg", name: "Echinopsis oxygona", tag: "Echinopsis oxygona", genus: ["Echinopsis"], region: ["Southern South America"], origin: "S Brazil / Uruguay / Argentina",
  ...
  { id: "gymnocalycium-saglionis-2", file: "photos/gymnocalycium-saglionis-2/IMG_9505.jpeg", name: "Gymnocalycium saglionis", tag: "Gymnocalycium saglionis", genus: ["Gymnocalycium"], region: ["Southern South America"], origin: "N Argentina",
  ...
  { id: "mammillaria-hahniana", file: "photos/mammillaria-hahniana/IMG_9506.jpeg", name: "Mammillaria hahniana", tag: "Mammillaria hahniana", genus: ["Mammillaria"], region: ["Mexico & SW USA"], origin: "Central Mexico",
  ...
  { id: "mammillaria-bombycina", file: "photos/mammillaria-bombycina/IMG_9507.jpeg", name: "Mammillaria bombycina", tag: "Mammillaria bombycina", genus: ["Mammillaria"], region: ["Mexico & SW USA"], origin: "Central Mexico",
  ...
  { id: "echinopsis-oxygona-2", file: "photos/echinopsis-oxygona-2/IMG_9508.jpeg", name: "Echinopsis oxygona", tag: "Echinopsis oxygona", genus: ["Echinopsis"], region: ["Southern South America"], origin: "S Brazil / Uruguay / Argentina",
  ...
  { id: "parodia-magnifica-1", file: "photos/parodia-magnifica-1/IMG_9509.jpeg", name: "Parodia magnifica", tag: "Parodia magnifica", genus: ["Parodia"], region: ["Southern South America"], origin: "S Brazil",
  ...
  { id: "parodia-magnifica-2", file: "photos/parodia-magnifica-2/IMG_9513.jpeg", name: "Parodia magnifica", tag: "Parodia magnifica", genus: ["Parodia"], region: ["Southern South America"], origin: "S Brazil",
  ...
  { id: "mammillaria-vetula", file: "photos/mammillaria-vetula/IMG_9510.jpeg", name: "Mammillaria vetula", tag: "— (tag not legible; identified by owner)", genus: ["Mammillaria"], region: ["Mexico & SW USA"], origin: "Central Mexico",
  ...
  { id: "mammillaria-elongata", file: "photos/mammillaria-elongata/IMG_9511.jpeg", name: "Mammillaria elongata", tag: "Mammillaria elongata", genus: ["Mammillaria"], region: ["Mexico & SW USA"], origin: "Central Mexico",
  ...
  { id: "cumulopuntia-boliviana", file: "photos/cumulopuntia-boliviana/IMG_9516.jpeg", name: "Cumulopuntia boliviana", tag: "Cumulopuntia boliviana", genus: ["Cumulopuntia"], region: ["Andes"], origin: "Bolivia / Peru / Argentina (Andes)",
  ...
  { id: "echinopsis-oxygona-bowl", file: "photos/echinopsis-oxygona-bowl/IMG_9517.jpeg", name: "Echinopsis offshoots", tag: "— (no tag; identified by owner)",
  ...
  { id: "kroenleinia-grusonii-2", file: "photos/kroenleinia-grusonii-2/IMG_9518.jpeg", name: "Kroenleinia grusonii", tag: "— (no tag; identified by owner)", genus: ["Kroenleinia"], region: ["Mexico & SW USA"], origin: "Central Mexico",
